  ...
  return (
    <nav className="nav" role="navigation" aria-label="Main navigation">
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%', maxWidth: '1200px', margin: '0 auto' }}>
        ...
        >
          <img src="/logo.jpg" alt="Knight Guide Logo" style={{ height: '40px', width: 'auto' }} />
          Knight Guide
        </Link>
  ...
  return (
    <div className="page">
      <div className="container">
        {/* Hero Section */}
        <div className="hero">
          <h1 className="hero-title animate-fadeIn" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '1rem', flexWrap: 'wrap' }}>
            <img src="/logo.jpg" alt="Knight Guide Logo" style={{ height: '80px', width: 'auto' }} />
            Knight Guide
          </h1>
          <p className="hero-subtitle animate-fadeIn" style={{ animationDelay: '0.1s' }}>
            Your accessibility-first AI travel companion.
            Plan trips tailored to your unique needs with intelligent recommendations.
          </p>
          ...
          <div style={{
            ...
            <Link to="/itinerary" className="btn btn-secondary" style={{ padding: '1rem 2.5rem', fontSize: '1.1rem' }}>
              ✨ Plan a Trip
            </Link>
          </div>
        </div>
        ...
        <div style={{
          ...
          {/* Plan Trip Card */}
          <Link to="/itinerary" className="feature-card" style={{ textDecoration: 'none' }}>
            <span className="feature-icon">🎯</span>
            <h3 style={{ fontSize: '1.25rem', fontWeight: '700', marginBottom: '0.75rem', color: 'var(--color-text-primary)' }}>
              AI Trip Planning
            </h3>
            <p style={{ color: 'var(--color-text-secondary)', margin: 0 }}>
              Generate personalized itineraries based on your accessibility needs. Smart recommendations for accessible venues.
            </p>
            <span style={{
          ...
          {/* Map Card */}
          <Link to="/map" className="feature-card" style={{ textDecoration: 'none' }}>
            <span className="feature-icon">🗺️</span>
            <h3 style={{ fontSize: '1.25rem', fontWeight: '700', marginBottom: '0.75rem', color: 'var(--color-text-primary)' }}>
              Accessibility Map
            </h3>
            <p style={{ color: 'var(--color-text-secondary)', margin: 0 }}>
              Find accessible locations with real-time scores. Filter by wheelchair access, hearing loops, braille signage.
            </p>
            <span style={{
              display: 'inline-block',
              marginTop: '1rem',
          ...
          {/* Profile Card */}
          <Link to="/profile" className="feature-card" style={{ textDecoration: 'none' }}>
            <span className="feature-icon">🆘</span>
            <h3 style={{ fontSize: '1.25rem', fontWeight: '700', marginBottom: '0.75rem', color: 'var(--color-text-primary)' }}>
              Emergency Alert
            </h3>
            <p style={{ color: 'var(--color-text-secondary)', margin: 0 }}>
              One-tap emergency alerts with your location and medical information. Safety first, always.
            </p>
            <span style={{
              display: 'inline-block',
              marginTop: '1rem',
          ...
          <div className="feature-card" onClick={() => {
            ...
            <p style={{ color: 'var(--color-text-secondary)', margin: 0 }}>
              Built-in text-to-speech reads any content aloud. Adjustable speed and voice selection.
            </p>
            <span style={{
              display: 'inline-block',
              marginTop: '1rem',
          ...
          {/* Volunteer Card */}
          <Link to="/volunteer" className="feature-card" style={{ textDecoration: 'none' }}>
            <span className="feature-icon">🤝</span>
            <h3 style={{ fontSize: '1.25rem', fontWeight: '700', marginBottom: '0.75rem', color: 'var(--color-text-primary)' }}>
              Volunteer Hub
            </h3>
            <p style={{ color: 'var(--color-text-secondary)', margin: 0 }}>
              Join our community of accessibility guardians. Verify locations and earn rewards.
            </p>
            <span style={{
              display: 'inline-block',
              marginTop: '1rem',
          ...
          {/* Sign Language Card */}
          <Link to="/sign-language" className="feature-card" style={{ textDecoration: 'none' }}>
            <span className="feature-icon">🤟</span>
            <h3 style={{ fontSize: '1.25rem', fontWeight: '700', marginBottom: '0.75rem', color: 'var(--color-text-primary)' }}>
              Sign Language
            </h3>
            <p style={{ color: 'var(--color-text-secondary)', margin: 0 }}>
              Text-to-Sign converter and interpretation resources to bridge communication gaps.
            </p>
            <span style={{
              display: 'inline-block',
              marginTop: '1rem',
        ...
        <div style={{
          ...
          <p style={{ color: 'var(--color-text-secondary)', maxWidth: '600px', margin: '0 auto 1.5rem' }}>
            Set up your accessibility profile once, and we'll personalize every trip recommendation for you.
          </p>
    ...
    <BrowserRouter>
      ...
      <main id="main-content">
        <Routes>
          ...
          <Route path="/itinerary" element={<Itinerary user={user} db={db} />} />
      ...
      <footer className="footer">
        <p className="footer-tagline">Knight Guide - Accessibility is not a feature. It is the floor.</p>
        <p>
